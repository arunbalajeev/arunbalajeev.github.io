(function() {
  ...
  saveRecording = function(blob, enc) {
    ...
    if(recorded_time<3){
	hint_text = "<font color='red'> Hint: Speech record is short.</font>"}
    html = ("<div style='height:120px'><p recording='" + url + "'>"+desc_text+"<br>") + ("<audio controls src='" + url + "'></audio> ") + ("<button style='margin-top:-20px' class='btn btn-danger' recording='" + url + "'>Delete</button>")+(hint_text);
    "</p></div>";
